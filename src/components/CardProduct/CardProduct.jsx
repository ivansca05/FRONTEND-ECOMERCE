...
const CardProduct = ({
    ...
    const handleAddToCart = async () => {
        await addToCart({_id, name, price, imageUrl, description, stock}) // Agrega 1 unidad del producto al carrito
        openModal() // Abre el modal del carrito después de agregar el producto
    }
